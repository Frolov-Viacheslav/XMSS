...
public class Main {
    ...
    public static void signing(Integer w, Integer N, String[] args, Integer keyIndex){
        ...
        MerkleCalculate(Message, Y, X, s, w, N, r);
        //Exit
        if(keysResidue == 0){
    ...
    public static void MerkleCalculate(String Message, String Y, String X, Integer s, Integer w, Integer N, String r){
        SignatureGeneration sg = new SignatureGeneration();
        SignatureVerification sv = new SignatureVerification();
        String Signature = sg.SignatureGeneration(Y, Message, s, w, PublicKeyGeneration.tree, N, PublicKeyGeneration.countLayer, PublicKeyGeneration.root, X, r);
        System.out.println("Signature = " + Signature);
        System.out.println("Y = " + Y);
        boolean verify = sv.allSignatureVerify(PublicKeyGeneration.countLayer, Signature, s, w, PublicKeyGeneration.root, SignatureGeneration.OneTimeSignature, Message, Y, r);
        if(verify)
