...
public class P_SignatureGeneration {
    ...
    public void generateSignature(String Message, Integer s, Integer w, String X, String r) {
        ...
        for (int i = 0; i < P_KeyPairGeneration.l; i++) {
            ...
            SIGNATURE += calculateSignatureI(Xi, b[i], s, r);
        }
    }

    private String calculateSignatureI(String Xi, Integer bi, Integer s, String r) {
        String ri = "";
        String sigi = Xi;
        for (int i = 0; i < bi; i++) {
